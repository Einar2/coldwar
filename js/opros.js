let vopros = [
    ...
    'Какую операцию провели ЦРУ во авганистане?',
...
let otvet2 = [
    ['1945', '1994', '1941', '2001'],
    ['1990', '1945', '1991', '1955'],
    ['Гарии Трумэн', 'Ио́сиф Ста́лин', 'Уинстон Черчилль', 'Шарль де Голль'],
    ['Ио́сиф Ста́лин', 'Гарии Трумэн', 'Шарль де Голль', 'Уинстон Черчилль'],
    ['Хаски', 'Сайклон', 'Оверлорд', 'Вьетнамский бросок'],
    ['Сайклон', 'Оверлорд', 'Хаски', 'Вьетнамский бросок'],
    ['Оверлорд', 'Вьетнамский бросок', 'Сайклон', 'Оверлорд'],
    ['1945', '1994', '1979', '2001'],
    ['Верховный лидер Китая', 'Верховный лидер США', 'Верховный лидер СССР', 'Верховный лидер России'],
    []
]
...
let content_img = document.querySelector('.opros_item_content img')
...
let btn_inner = () => {
    ...
    if (step == 3) {
        content_img.src = 'img/game_cherchil.jpg'
    }
    else if (step == 6) {
        content_img.src = 'img/lid_truman.jpg'
    }
    else if (step == 9) {
        btns.forEach(item => {
            item.remove()
